...
def crear_actividades_desde_entradas(num_actividades):
    actividades = []
...
def calcular_ruta_critica():
    num_actividades = int(num_actividades_entry.get())
    actividades = crear_actividades_desde_entradas(num_actividades)
...
# Cuadro de texto para mostrar la ruta crítica
ruta_critica_text = tk.Text(ruta_critica_frame, width=50, height=5)
